...
public static partial class Converter
{
    ...
    public static IValueConverter<byte, string> ConvertToString(this BindingConverter<byte, string> _,
        NumberStyles style = NumberStyles.Any,
        IFormatProvider? formatProvider = null) =>
        Create(_,
            value => value.ToString(formatProvider),
            value => byte.TryParse(value, style, formatProvider, out var val) ? val : default);
    ...
    public static IValueConverter<byte?, string?> ConvertToString(this BindingConverter<byte?, string?> _,
       ...
       Create(_,
           value => value?.ToString(formatProvider),
           value => byte.TryParse(value, style, formatProvider, out var val) ? val : null);
}