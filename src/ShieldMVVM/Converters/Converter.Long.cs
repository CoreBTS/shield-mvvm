...
public static partial class Converter
{
    ...
    public static IValueConverter<long, string> ConvertToString(this BindingConverter<long, string> _,
        NumberStyles style = NumberStyles.Any,
        IFormatProvider formatProvider = null) =>
        Create(_,
            value => value.ToString(formatProvider),
            value => long.TryParse(value, style, formatProvider, out var val) ? val : default);
    ...
    public static IValueConverter<long?, string> ConvertToString(this BindingConverter<long?, string> _,
       ...
       Create(_,
           value => value?.ToString(formatProvider),
           value => long.TryParse(value, style, formatProvider, out var val) ? val : null);
}