...
#pragma warning disable CS0618 // Type or member is obsolete - Generated against Microsoft DLLs
    ...
    /// <summary>
    /// Allows binding to the SemanticProperties.HeadingLevel as BindSemanticHeadingLevel for the BindableObject control.
    /// </summary>
    /// <param name="_">Extension parameter.</param>
    /// <returns>Generic BindableProperty of type BindableObject.</returns>
    public static Bindings.BindableProperty<SemanticHeadingLevel> BindSemanticHeadingLevel<T>(this T _) where T : BindableObject => Bindings.BindableProperty<SemanticHeadingLevel>.Create(SemanticProperties.HeadingLevelProperty);

    /// <summary>
    /// Allows binding to the SemanticProperties.Description as BindSemanticDescription for the BindableObject control.
    /// </summary>
    /// <param name="_">Extension parameter.</param>
    /// <returns>Generic BindableProperty of type BindableObject.</returns>
    public static Bindings.BindableProperty<String> BindSemanticDescription<T>(this T _) where T : BindableObject => Bindings.BindableProperty<String>.Create(SemanticProperties.DescriptionProperty);

    /// <summary>
    /// Allows binding to the SemanticProperties.Hint as BindSemanticHint for the BindableObject control.
    /// </summary>
    /// <param name="_">Extension parameter.</param>
    /// <returns>Generic BindableProperty of type BindableObject.</returns>
